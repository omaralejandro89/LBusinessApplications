...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     *
     * Both server and the app must cooperate in order to eliminate these threats. Angular comes
    ...
    if (lowercase(method) == 'jsonp') {
      ...
      if (responseType) {
        try {
          ...
          // parsed on the app-side regardless.
 ...
 *
 * For the case of HTML, you might use a library, either on the app side, or on the server side,
 ...
 *
 * Since the role of forms in app-side Angular applications is different than in classical
